...
- (id)initWithCoder:(NSCoder *)coder
{
    ...
    if (self) {
        ...
        self.lineWidth = [[coder decodeObjectForKey:@"lineWidth"] intValue];
...
-(void)encodeWithCoder:(NSCoder *)aCoder{
    ...
    [aCoder encodeObject:[NSString stringWithFormat:@"%d",self.lineWidth] forKey:@"lineWidth"];
}
...
-(void)drawCircle{
    ...
    [firstHalf setLineWidth:self.lineWidth];
    [firstHalf stroke];
    ...
    [secondHalf setLineWidth:self.lineWidth];
    [secondHalf stroke];
