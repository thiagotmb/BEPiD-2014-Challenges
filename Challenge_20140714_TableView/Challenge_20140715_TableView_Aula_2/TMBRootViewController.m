...
- (void)viewDidLoad
{
    ...
    self.numbers = [[NSMutableArray alloc] initWithObjects:@"Um",@"Dois",@"Tres",@"Quatro",@"Cinco",@"Seis",@"Sete",@"Oito",@"Nove",@"Dez", nil];
...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    ...
    if(buttonIndex == 1){
        ...
        NSIndexPath *indexPath = [NSIndexPath indexPathForRow:self.numbers.count inSection:0];
